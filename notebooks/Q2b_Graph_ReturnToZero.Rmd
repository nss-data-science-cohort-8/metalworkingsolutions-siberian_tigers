...
```{r}
TopN_Highly_InDemand_Parts_ID_y_LongDescription_Intermediate_Step_see_TotalQuantityEachPart <- Q2b_Data |> 
...
TopN_Highly_InDemand_Parts_ID_y_LongDescription_Intermediate_Step_see_TotalQuantityEachPart
```
...
# saveRDS(complete_data_CSV, "../data/completed_table.Rds")
```
